...
/** Online düello route'u: /match/[id]. content=wordrace → Kelime Yarışı;
 *  content=word → kelime düellosu; aksi halde sayı düellosu (mevcut ekran AYNEN).
 *  Tüm realtime/oyun mantığı ekranlarda. id yoksa (ör. cihaz ölü/parametresiz geri
...
export default function MatchRoute() {
  ...
  if (content === 'wordrace') return <WordRaceScreen matchId={id} />;
